    ...
    <div class="flexcarty">
              ...
              <div class="col s12 m7">
                <div class="card" style="width: 350px;">
                  <div class="card-image">
                    ...
                    <img class="imgborder modifywww" src="{{ url('assets/img/uploadPresentation') }}/{{$presentation->miniature}}" />
                    <span class="card-title bkkk bckcard">{{$presentation->tittle}}</span>
                  </div>
       ...
       <div class="itflx2">
           ...
           <form
              class="all flxi"
              method="POST"
              action="{{ action('SpeakerResourceController@editPresentation', $idpresentation) }}"
            ...
            >
              ...
              <div class="flxi1">
                  ...
                  <div class="imageblah yu">
                    <img id="blah" src="#" alt="your image" />
                  </div>
                  <div class="form-group row drag drekc">
                    <label
                      for="custom"
              ...
              <div class="flxi2">
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="description" class="form-control" id="exampleFormControlTextarea1" rows="5">{{$presentation->description}}</textarea>
                  </div>
                  ...
                  <div class="form-group column">
                    ...
                    <div class="col-md-6">
                      <input
                        ...
                        name="video"
                        value="https://youtu.be/{{$presentation->video}}"
                        required
                        autocomplete="name"
                        autofocus
                      />
                  ...
                  <div class="form-group row mb-0">
                    <div class="col-md-6 offset-md-4">
                      <button type="submit" class="btn btn-primary cssss kkij">
                        {{ __('Update presentation') }}
                      </button>
                    </div>
                  </div>
